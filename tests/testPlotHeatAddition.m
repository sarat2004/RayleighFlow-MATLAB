function tests = testPlotHeatAddition
%TESTPLOTHEATADDITION Test plotHeatAddition.
...
function testContainsHeatCurve(testCase)
...
function testInvalidMachRejected(testCase)
    ...
    verifyError(testCase, ...
        @() plotHeatAddition([0.2 0 1.0], 1.4), ...
...
function testNegativeMachRejected(testCase)
    ...
    verifyError(testCase, ...
        @() plotHeatAddition([0.2 -0.5 1.0], 1.4), ...
        'validateInput:InvalidMach');
...
function testInvalidGammaRejected(testCase)
    ...
    verifyError(testCase, ...
        @() plotHeatAddition([0.2 0.5 1.0], 1.0), ...
...
function testNonScalarGammaRejected(testCase)
    ...
    verifyError(testCase, ...
        @() plotHeatAddition([0.2 0.5 1.0], [1.3 1.4]), ...
        'validateInput:InvalidGamma');
